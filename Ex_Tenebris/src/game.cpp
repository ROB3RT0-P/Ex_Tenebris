...
bool Game::loadInitialResources()
{
	...
	debugText = new Text(gRenderer, "data/Fonts/kenneyPixel.ttf", debugTextSize_, debugTextColor_);
	gameText = new Text(gRenderer, "data/Fonts/kenneyPixel.ttf", textSize_, textColor_);
	consoleText = new Text(gRenderer, "data/Fonts/kenneyPixel.ttf", textSize_, textColor_);
